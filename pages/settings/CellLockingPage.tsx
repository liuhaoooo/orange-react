...
import { RadioGroup } from '../../components/UIComponents';

const WarningBanner = ({ title, text }: { title: string, text: string }) => (
    <div className="bg-[#fff8e1] p-4 mb-6 rounded-sm border-l-4 border-[#ff7900]/0"> 
                ...
                <div className="flex flex-col sm:flex-row sm:items-center mb-8">
                    ...
                    <RadioGroup 
                        ...
                        options={[
                            ...
                            { label: 'Lock Specific Physical Cell', value: 'lock' }
                        ]}
                    />
                </div>
