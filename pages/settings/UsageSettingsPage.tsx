...
const StyledTextarea = (props: React.TextareaHTMLAttributes<HTMLTextAreaElement>) => (
  <textarea
    {...props}
    className="w-full border border-gray-300 px-3 py-2 text-sm text-black outline-none focus:border-orange focus:ring-1 focus:ring-orange transition-all rounded-[2px] bg-white min-h-[100px] resize-y font-sans"
  />
);
    ...
    <div className="w-full animate-fade-in py-2">
          ...
          <div className="flex w-full">
              <div className="flex-1">
                  <input 
                    ...
                    className="w-full border border-gray-300 px-3 py-2 text-sm text-black outline-none focus:border-orange focus:ring-1 focus:ring-orange transition-all rounded-l-[2px] bg-white border-r-0"
                  />
              </div>
              <div className="w-24 relative">
                  <select 
                    ...
                    className="w-full border border-gray-300 px-3 py-2 text-sm text-gray-600 outline-none focus:border-orange focus:ring-1 focus:ring-orange transition-all rounded-r-[2px] appearance-none bg-[#f3f4f6] cursor-pointer font-bold"
                  >
      ...
      <FormRow label="When reached" required>
          <div className="flex items-center">
              ...
              <span className="text-black text-sm font-medium">% to remind me</span>
          </div>
      </FormRow>
